...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center gap-3 border-b border-border bg-background/80 backdrop-blur-md px-6 md:px-8">
      ...
      <div className="ml-auto flex items-center gap-2">
        {/* Model badge */}
        <div className="flex items-center gap-1.5 rounded-md border border-border bg-muted/40 px-3 py-1.5 text-sm text-muted-foreground font-mono">
